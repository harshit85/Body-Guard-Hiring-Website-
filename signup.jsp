  ...
  <!--Header-->
    ...
    <nav class="navbar navbar-default navbar-static-top">
  	...
  	<section class="row checkout-content">
  		<div class="container">
  			<div class="row">
  				<form class="col-md-9 checkout-form" action="http://localhost:8080/examples/Atul%20site/signup1.jsp" method="post" role="form" data-toggle="validator">
					<h3 class="checkout-heading">Personal information</h3>
					<div class="row">
						<div class="col-sm-6 form-group">
							<label for="fname">Name</label>
							<input type="text" class="form-control" name="username" required="required" id="fname">
						</div>
            <div class="col-sm-6 form-group">
              <label for="fname">Mobile no</label>
              <input type="text" class="form-control" name="mobile" required="required" id="fname">
            </div>
              <div class="col-sm-12 row payments">
                <div class="option row">
                  <input type="radio" name="sex" value="male" id="payM1">
                  <label for="payM1">Male</label>
                  <input type="radio" name="sex" value="female" id="payM2">
                  <label for="payM2">Female</label>
                </div>
              </div>
            <div class="col-sm-6 form-group">
            ...
            <div class="col-sm-6 form-group">
              ...
              <input type="password" class="form-control" name="password" required="required" id="e-address">
					...
					<h3 class="checkout-heading child2">Address</h3>
					<div class="row">
						<div class="col-sm-12 form-group">  					
							<input type="text" class="form-control" name="street1" placeholder="Street Address">
            ...
            <div class="col-sm-4 form-group">
              ...
              <input type="text" class="form-control" name="state" id="city">
						...
						<div class="col-sm-4 form-group">
							<label for="pocode">Pin Code</label>
							<input type="text" class="form-control" name="pincode" id="pocode">
						</div>
					</div>
