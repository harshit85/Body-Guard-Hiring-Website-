  		...
  		<div class="container">
  			<div class="table-responsive">
  				<table class="table cart-table">
  					<thead>
  						<tr>
  							<th class="col-xs-4">Item Description</th>
              ...
              <%@ page import="java.sql.*" %>
                      ...
                      try{
                         ...
                         ResultSet r=s.executeQuery("select *from cart where customerId="+"'"+(String)session.getAttribute("Id")+"'");
                         ...
                         Statement s2=conn.createStatement();
                          ...
                          {
                              s1=r.getString(3);
                              ResultSet rs=s2.executeQuery("select *from bodyguard_details where id="+"'"+s1+"'");
                              while(rs.next())
                              {                  
                      %>
                          <tr class="alert fade in" role="alert">
                            <td>
                              <div class="media">
                                <div class="media-left"><a href="#"><img src="<%= rs.getString(8)%>" alt=""></a></div>
                            ...
                            <td><%= rs.getString(7)%></td>
                            <td><button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="getData('Deletetocart.jsp?ur=<%= rs.getString(1)%>','thumb1')">remove</button></td>
                          </tr> 
                      <%
  			...
  			<div class="row">
  				<div class="col-md-6">
  					<div class="cart-related-boxs row">
  						<h4 class="this-title">Have a Promotional Code ?</h4>
  						<form action="#" method="post" class="input-group cupon-get form-box">
  							<input type="text" class="form-control">
  							<span class="input-group-addon"><input type="submit" class="btn btn-default" value="apply code"></span>
  						</form>
  					</div>
  				</div>
  				<div class="col-md-6">
  					<div class="cart-related-boxs row">
  						...
  						<form action="#" method="post" class="input-group cupon-get form-box">
  							...
  							<div class="row m0 text-right"><input type="submit" value="Submit Your Order" class="btn btn-primary"></div>
  						</form>
  					</div>
  				</div>
  			</div>  			
